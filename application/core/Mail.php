...
class Mail
{
	 ...
	 */
	public static function sendMailWithPHPMailer($user_email, $from_email, $from_name, $subject, $body)
	{
		$mail = new PHPMailer;
		...
		$mail->IsHTML(true);
		$mail->Body = file_get_contents(Config::get('PATH_VIEW') . '_templates/email/header.php').
					  $body;
					  file_get_contents(Config::get('PATH_VIEW') . '_templates/email/footer.php').
