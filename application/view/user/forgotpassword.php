...
<head>
    ...
    <title><?php echo System::Get('sitename'); ?> - Password reset</title>
...
<body class="gray-bg">
    ...
    <div class="loginColumns animated fadeInDown">
		...
		System::success(Request::get('success'));
		?>
        <div class="row">
            <div class="col-md-6 ">
                ...
                <div class="ibox-content">
                    ...
                    <input type="hidden" name="user_login" value="1">
					 <div class="form-group">
                            <input type="email" value="<?php echo System::escape(Request::get('email')); ?>" name="email" class="form-control" placeholder="Email" required="">
                        </div>
